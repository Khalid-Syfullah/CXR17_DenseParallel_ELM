...
public class XRayActivity extends AppCompatActivity {
    ...
    TextView classText, accuracyText, timeText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        classifierBtn =(Button)findViewById(R.id.xRayCheckButton);
        classText =(TextView)findViewById(R.id.xRayClassifytext);
        accuracyText=(TextView)findViewById(R.id.xRayClassifytext2);
        timeText=(TextView)findViewById(R.id.xRayClassifytext3);

        backBtn=findViewById(R.id.xRayBackBtn);


        classText.setText("Upload your Image");
...
//            MappedByteBuffer tfliteModel = fileChannel.map(FileChannel.MapMode.READ_ONLY, startoffset, declaredLength);
            ...
            MappedByteBuffer tfliteModel = FileUtil.loadMappedFile(XRayActivity.this,"ParallelCNN_ELM.tflite");
            Interpreter tflite = new Interpreter(tfliteModel, tfliteOptions);

            // Loads labels out from the label file.
            labels = FileUtil.loadLabels(XRayActivity.this,"labels.txt");
